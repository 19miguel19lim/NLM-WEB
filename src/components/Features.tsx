  ...
  const features = [
    {
      ...
      description:
        "At TrueNorth, we're not just an external agency to your business. We look at ourselves as your partner in growth. It's not just all numbers and ROI with us, its building deep partnerships as well.",
    },
    {
      icon: TrendingUp,
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-heading font-bold text-foreground mb-6">
            Why Does the Industry Choose TrueNorth?
          </h2>
        ...
        <div className="text-center mt-16">
          <p className="text-muted-foreground mb-6">
            Ready to experience the TrueNorth difference?
          </p>
